  ...
  (() => {
      ...
      Rl = (e, t, n, r) => {
        if ((t && typeof t == "object") || typeof t == "function")
          for (let i of ic(t))
            !oc.call(e, i) &&
              i !== n &&
              Ma(e, i, { get: () => t[i], enumerable: !(r = rc(t, i)) || r.enumerable });
        return e;
      };
    var Bl = (e, t, n) => (
        (n = e != null ? ac(lc(e)) : {}),
        Rl(t || !e || !e.__esModule ? Ma(n, "default", { value: e, enumerable: !0 }) : n, e)
      ),
    ...
    var Jl = zr((La) => {
      ...
      var $c = (Ln(), cc(Wr)),
        ...
        Yc = $c.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
      ...
      function Kl(e, t, n) {
        ...
        return { $$typeof: Wc, type: e, key: l, ref: o, props: i, _owner: Yc.current };
      }
      La.Fragment = qc;
      La.jsx = Kl;
      La.jsxs = Kl;
    ...
    var no = zr((X9, to) => {
      ...
      var Ta = {
        ...
        easeInBounce: function (e, t, n, r) {
          var i = n - t,
            l;
          return ((l = Ta.easeOutBounce(r - e, 0, i, r)), i - l + t);
        },
        ...
        easeInOutBounce: function (e, t, n, r) {
          var i = n - t,
            l;
          return e < r / 2
            ? ((l = Ta.easeInBounce(e * 2, 0, i, r)), l * 0.5 + t)
            : ((l = Ta.easeOutBounce(e * 2 - r, 0, i, r)), l * 0.5 + i * 0.5 + t);
        },
      };
      to.exports = Ta;
    });
    ...
    var mf = __STORYBOOK_API__,
      {
        ...
        merge: Lf,
        mockChannel: Tf,
        optionOrAltSymbol: Of,
        shortcutMatchesShortcut: _f,
    ...
    function Jr(
      ...
      if (h === 0) ((v[0] = 0), (C = v[1] = Kr.symbol[m][t ? ql : Gl][b]));
        ...
        ((v[0] = Q(E * de) / de),
          ...
          (C = v[1] = r === 10 && b === 1 ? (t ? jc : "kB") : Kr.symbol[m][t ? ql : Gl][b]));
      }
      if (
        (Y && (v[0] = -v[0]),
      ...
      return (
        R && (v[1] = f[b] ? f[b] : Kr.fullform[m][b] + (t ? "bit" : Ic) + (v[0] === 1 ? "" : "s")),
        u === Zc ? v : u === Hc ? { value: v[0], symbol: v[1], exponent: b, unit: C } : v.join(c)
      );
    }
    ne();
    ae();
    re();
    var On = __REACT_DOM__,
      {
        __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: _9,
        createPortal: _n,
        createRoot: Z9,
        findDOMNode: I9,
        flushSync: R9,
    ...
    var Xc = 1e3 / 60,
        ...
        constructor(t, n) {
          ((this.lastFrameTime = 0),
            (this.setOptionsWithDefaults = (i) => {
              ...
              ((this._options = { ...l, ...ri, ...i }), Object.assign(this, i.confettiSource));
            }),
            (this.update = (i = 0) => {
              let {
      ...
      In = class extends a.Component {
        constructor(t) {
          (super(t), (this.canvas = a.createRef()), (this.canvas = t.canvasRef || ed));
        }
        componentDidMount() {
          if (this.canvas.current) {
            let t = Xr(this.props)[0];
    ...
    function Xr(e) {
      let t = {},
        n = {},
        r = {},
        i = [...Object.keys(ri), "confettiSource", "drawShape", "onConfettiComplete", "frameRate"],
        l = ["canvasRef"];
      for (let o in e) {
        let s = e[o];
    ...
    var nd = Object.create,
      ...
      sd = (e, t, n, r) => {
        if ((t && typeof t == "object") || typeof t == "function")
          for (let i of rd(t))
            !ld.call(e, i) &&
              i !== n &&
              j1(e, i, { get: () => t[i], enumerable: !(r = ad(t, i)) || r.enumerable });
        return e;
      },
      at = (e, t, n) => (
        (n = e != null ? nd(id(e)) : {}),
        sd(t || !e || !e.__esModule ? j1(n, "default", { value: e, enumerable: !0 }) : n, e)
      ),
      Sr = Pt((e, t) => {
        (function (n, r) {
          typeof od == "function" && typeof e == "object" && typeof t == "object"
            ? (t.exports = r())
      ...
      e5 = w(qr)(({ theme: e }) => ({ padding: "4px 8px", fontSize: e.typography.size.s1 })),
      t5 = w(Ke)(
        ({ theme: e }) => ({
      ...
      l5 = ({ status: e }) => e?.[P]?.status === "warn" || e?.[P]?.status === "error",
...
`),
    ...
    function Qa(e) {
      ...
      else if ((n = ze(C5))) t = { kind: "StringValue", value: y5(n.slice(3, -3)), block: !0 };
      else if ((n = ze(S5)))
...
`),
      ...
      cn = (e) => {
        ...
        if (Array.isArray(e)) {
          ...
          return (t += "]");
        } else if ((Ja !== vn && e instanceof Ja) || (Xa !== vn && e instanceof Xa)) return "null";
...
# ${n}`,
      ...
      pn = (e, t, n) => {
        var r = t || {},
          ...
          l = Ka(r),
          o = i.__key;
        return (l !== "{}" && (o = Ii(l, o)), { key: o, query: i, variables: r, extensions: n });
      },
      us = (e) => {
    ...
    var z5 = (e, t) => {
      ...
      U5 = (e, t) => {
        if (t && !(e.kind === "query" && e.context.preferGetMethod)) {
          var n = Ka(t),
            r = ((s) => {
              var c = new Map();
              return ((Ja !== vn || Xa !== vn) && (Wt.clear(), Ri(c, "variables", s)), c);
            })(t.variables);
          if (r.size) {
            var i = new FormData();
            (i.append("operations", n), i.append("map", Ka({ ...[...r.keys()].map((s) => [s]) })));
            var l = 0;
      ...
      q5 = /boundary="?([^=";]+)"?/i,
      G5 = /data: ?([^\n]+)/,
      vo = (e) => (e.constructor.name === "Buffer" ? e.toString() : W5.decode(e));
    async function* yo(e) {
      if (e.body[Symbol.asyncIterator]) for await (var t of e.body) yield vo(t);
        ...
        var n = e.body.getReader(),
          r;
        try {
          for (; !(r = await n.read()).done;) yield vo(r.value);
        } finally {
          n.cancel();
        }
      }
...
`,
    ...
    var K5 = () => {},
        ...
        (n) => {
          var r = Ga((l) => {
              var o = j5(l),
                s = z5(l, o),
                c = $5(l, o),
                d = ns(Ve((m) => m.kind === "teardown" && m.key === l.key)(n))(Q5(l, s, c));
              return d;
            })(
              Ve(
                (l) =>
      ...
      nu = function e(t) {
        ...
        var p = (h) => {
            var v = ns(Ve((E) => E.kind === "teardown" && E.key === h.key)(c.source))(
              Ve(
                (E) =>
            ...
            return (
              t.maskTypename && (v = Ti((E) => ({ ...E, data: Pi(E.data, !0) }))(v)),
              h.kind !== "query"
          ...
          y = K5,
          k = X5(t.exchanges),
          b = ea(k({ client: g, dispatchDebug: y, forward: tu({ dispatchDebug: y }) })(c.source));
        return (g5(b), g);
      },
    ...
    function au(e) {
      return ({ client: t, forward: n }) => {
        ...
        return (u) => {
          ...
          p();
          function f(b) {
            (o.set(b.key, si(b, !0)), m && !d && (d = m.refreshAuth().then(s).catch(c)));
          }
          function g(b) {
                ...
                b.kind === "teardown"
                  ...
                  : b.context._instance && r.has(b.context._instance)
                    ...
                    : b.context.authAttempt
                      ? g(b)
                      : d || !m
                        ? (d || p(), o.has(b.key) || o.set(b.key, si(b, !1)), null)
                        : (function (h) {
                              return (
    ...
    var fl = () => {
      ...
      ci = (e, t) => {
        ...
        return ((r, i) => {
          ...
          for (var o in i) if (o === "operation" ? !lu(r[o], i[o]) : r[o] !== i[o]) return !0;
          return !1;
        })(e, n)
          ? n
          : e;
    ...
    var hs = () => {
        let [{ token: e }, t] = Pl(`${P}/accessToken`, { token: dt }),
          n = a.useCallback(
            (r) => {
              (nr(r), t({ token: dt }));
            },
      ...
      yu = ({ children: e, value: t = gs() }) => a.createElement(iu, { value: t }, e),
      bt = (e, t) => {
        let n = Ht(e);
      ...
      Ar = De(null),
      bu = ({ children: e, value: t }) => a.createElement(Ar.Provider, { value: t }, e),
      $e = (e, t) => {
      ...
      ys = class {
        ...
        get(e) {
          return (this.state[e] || this.channel.emit(wo, e), this.state[e]?.value);
        }
        set(e, t) {
      ...
      Es = {
        ...
        upload: {
          ...
          renderProgress: ({ stepProgress: e }) => {
            ...
            let { value: r, exponent: i } = Jr(n, { output: "object", round: 1 }),
              { value: l, symbol: o } = Jr(t, { exponent: i, output: "object", round: 1 });
    ...
    var j = w.div(
      ...
      vl = ({ localBuildProgress: e, withEmoji: t = !1, ...n }) => {
        let { emoji: r, renderProgress: i } = Es[e.currentStep],
          l = i(e);
    ...
    function ji(e) {
      ...
      return (
        (ji = function (n) {
          ...
          function r() {
            return Su(n, arguments, Di(this).constructor);
          }
          return (
    ...
    function ws(e) {
      ...
      var l = Tu.exec(t.substring(0, 50));
      if (l)
        return {
          red: parseInt("" + l[1], 10),
    ...
    function $i(e, t, n, r) {
      if (typeof e == "string" && typeof t == "number") {
        ...
        if (
          ...
          return r >= 1 ? Ui(e, t, n) : "rgba(" + e + "," + t + "," + n + "," + r + ")";
        if (typeof e == "object" && t === void 0 && n === void 0 && r === void 0)
          return e.alpha >= 1
    ...
    function zu(e, t) {
      ...
      var n = Cs(t);
      return Ss(ar({}, n, { lightness: Ns(0, 1, n.lightness - parseFloat(e)) }));
    }
    var Uu = Ms(zu),
      zt = Uu;
    function $u(e, t) {
    ...
    var qu = se({
      ...
      Os = ({ status: e }) => a.createElement(Ts, { status: e }),
      i2 = w.div({
        position: "relative",
        display: "inline-flex",
      ...
      ir = ({ status: e, children: t }) =>
        a.createElement(i2, null, t, a.createElement(Ts, { overlay: !0, status: e })),
      Fe = w(Wl)(({ theme: e }) => ({ marginBottom: "-4px", marginTop: "-4px", left: -8 })),
      l2 = w.div(({ theme: e }) => ({
        width: 220,
        padding: 3,
        color: e.base === "light" ? e.color.defaultText : e.color.light,
      ...
      o2 = At({ "0%": { transform: "rotate(0deg)" }, "100%": { transform: "rotate(360deg)" } }),
      hi = w.svg(
        ({ progress: e, theme: t }) => ({
          position: "absolute",
          ...
          return l
            ? a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(ir, { status: "warning" }, a.createElement(Zt, null)),
                ),
              )
            : a.createElement(
                Rn,
            ...
            be,
            {
              ...
              tooltip: a.createElement(
                ...
                a.createElement(
                  "div",
                  null,
                  a.createElement(vl, { localBuildProgress: i, small: !0, withEmoji: !0 }),
                ),
                a.createElement(
                  bl,
                  null,
                  typeof d == "number" && a.createElement(_s, { style: { width: `${d}%` } }),
                ),
                t &&
                  a.createElement(
                    s2,
        ...
        return n
          ? a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(ir, { status: "notification" }, a.createElement(Zt, null)),
              ),
            )
          : a.createElement(
              be,
      ...
      Zs = De(null),
      u2 = ({ children: e, value: t }) => a.createElement(Zs.Provider, { value: t }, e),
      Is = () => bt(Zs, "AuthState"),
      m2 = {
      ...
      f2 = w(El)(
        {
          ...
          display: "block",
          verticalAlign: "top",
          path: { fill: V.medium, animation: `${As} 1.5s ease-in-out infinite` },
        },
        (e) => ({
      ...
      v2 = ({
        ...
        let o = a.createElement(f2, { icon: i === "user" ? "useralt" : "repository", type: i }),
          s = {};
        return (
          e
            ...
            : n
              ...
              : ((s["aria-label"] = t),
                (o = a.createElement(g2, { size: r, "aria-hidden": "true" }, t.substring(0, 1)))),
          a.createElement(h2, { size: r, isLoading: e, src: n, type: i, ...s, ...l }, o)
        );
      },
      y2 = w.span(
        (e) =>
    ...
    var w2 = w.label((e) => ({
      ...
      Bs = U(
        (
          ...
          let [h, v] = Ce(So({ error: r, value: y, lastErrorValue: c })),
            E = `${e}-error`;
          X(() => {
            v(So({ error: r, value: y, lastErrorValue: c }));
          }, [y, r, c]);
          let C = a.createElement(S2, {
    ...
    var Ps = U(({ type: e, startFocused: t, ...n }, r) => {
      ...
      return (
        ...
        a.createElement(Bs, { ref: c, startingType: e, type: i, onActionClick: o, ...n })
      );
    });
    ...
    var T2 = w.div(
      ...
      kl = ({ active: e, activeColor: t, disabled: n, isLoading: r, theme: i }) => ({
      ...
      V2 = w.span(kl),
      H2 = O2((e) =>
        w(({ active: t, isLoading: n, activeColor: r, ...i }) => a.createElement(e, { ...i }))(kl),
      ),
      Xe = ({
        ...
        if (o) {
          let u = H2(o);
          return a.createElement(xo, null, a.createElement(u, { activeColor: d, ...c }, m));
        }
        return a.createElement(xo, null, a.createElement(s ? P2 : V2, { activeColor: d, ...c }, m));
      };
    function qn(e) {
      function t(Z, R) {
        return (Z >>> R) | (Z << (32 - R));
    ...
    var D2 = (e) => new Uint8Array(e).reduce((t, n) => t + String.fromCharCode(n), ""),
      j2 = (e) => window.btoa(Array.isArray(e) ? D2(e) : e),
      Mo = (e) => j2(e).replace(/\+/g, "-").replace(/\//g, "_").replace(/=/g, ""),
      ...
      q2 = async (e) => {
        let t = Mo(U2()),
          ...
          r = await fetch(`${xr}/authorize`, {
            ...
            body: Vs({ client_id: "chromaui:addon-visual-tests", code_challenge: n }),
          }),
          {
            device_code: i,
            user_code: l,
    ...
    var Ds = De(void 0),
      ...
      Lr = { width: 14, height: 14, margin: "2px 6px 2px 0", verticalAlign: "top" },
      X2 = w(Id)(Lr),
      em = w(gd)(Lr),
      tm = w(z1)(Lr),
      nm = w(yd)(Lr),
              ...
              a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      a.createElement(
                        Lo,
                        null,
                        a.createElement(To, null, d, " "),
                        d in Kd && a.createElement(dm, null, "*Disabled for local builds"),
                      ),
                      a.createElement(_o, null, am[d]?.description),
                      a.createElement(
                        Oo,
                        null,
                        a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(
                    Ao,
                    null,
                    a.createElement(Lo, null, a.createElement(To, null, "Uninstall addon")),
                    a.createElement(
                      _o,
                      null,
                      "Removing the addon updates your Storybook configuration and uninstalls the dependency.",
                    ),
                    a.createElement(Oo, null, a.createElement(le, { onClick: t }, "Uninstall")),
                  ),
                ),
              ),
          ),
      ...
      Or = () => {
        let { accessToken: e, setAccessToken: t } = Is(),
          { toggleConfig: n } = Mn(),
          [r] = we(K1),
          { projectId: i } = r || {},
          l = [
        ...
        return a.createElement(aa, { placement: "top", links: l }, a.createElement(Ed, null));
      };
    ...
    var bm = w.div(
            ...
            ? a.createElement(
                ...
                a.createElement(
                  ...
                  a.createElement(
                    Je,
                    { push: !0 },
                    a.createElement(Ke, { onClick: d }, a.createElement(sl, null)),
                  ),
                ),
              )
            : null;
      ...
      fe = ({
        ...
        footer: t = a.createElement(
          ...
          a.createElement(Je, null, a.createElement(Or, null)),
        ),
        ignoreConfig: n = !1,
        ...
        return a.createElement(
          Sm,
          null,
          a.createElement(Cm, { onOpen: o, hidden: i, ignoreConfig: n, ignoreSuggestions: r }),
          a.createElement(Ro, { hidden: i }, e),
          a.createElement(Ro, { hidden: !i }, a.createElement(hm, { onClose: () => l(!1) })),
          t,
        );
      },
      xm = w.div(({ theme: e }) => ({
        ...
        a.createElement(
          ...
          e &&
            a.createElement(
              Je,
              null,
              a.createElement(Bo, { onClick: e }, a.createElement(Fd, null), "Back"),
            ),
          a.createElement(
            Je,
            { push: !0 },
      ...
      Tm = ({ onBack: e, onSignIn: t }) => {
        ...
        return a.createElement(
          ...
          a.createElement(
            ue,
            null,
            a.createElement("div", null, a.createElement(js, null), a.createElement(Xt, null)),
      ...
      Om = ({ onBack: e, onSignIn: t, onSignInWithSSO: n }) =>
        a.createElement(
          fe,
          { footer: null, ignoreConfig: !0 },
          a.createElement(Zr, { onBack: e }),
    ...
    function L(e, t) {
      let n = sr({
        ...
        data: e.data,
        path: e.path,
        errorMaps: [e.common.contextualErrorMap, e.schemaErrorMap, or(), ra].filter((r) => !!r),
      });
    ...
    var G = class {
        ...
        brand() {
          return new Ks({ typeName: H.ZodBranded, type: this, ...$(this._def) });
        }
        catch(e) {
          let t = typeof e == "function" ? e : () => e;
          return new hr({ ...$(this._def), innerType: this, catchValue: t, typeName: H.ZodCatch });
        }
        describe(e) {
    ...
    la.create = (e) => new la({ typeName: H.ZodBoolean, coerce: e?.coerce || !1, ...$(e) });
    ...
    yn.create = (e) =>
      new yn({ checks: [], coerce: e?.coerce || !1, typeName: H.ZodDate, ...$(e) });
    ...
    dr.create = (e) => new dr({ typeName: H.ZodSymbol, ...$(e) });
    ...
    oa.create = (e) => new oa({ typeName: H.ZodUndefined, ...$(e) });
    ...
    sa.create = (e) => new sa({ typeName: H.ZodNull, ...$(e) });
    ...
    bn.create = (e) => new bn({ typeName: H.ZodAny, ...$(e) });
    ...
    ur.create = (e) => new ur({ typeName: H.ZodVoid, ...$(e) });
    ...
    ca.create = (e, t) => new ca({ options: e, typeName: H.ZodUnion, ...$(t) });
    var qa = (e) =>
        e instanceof ua
          ? qa(e.schema)
          : e instanceof nt
      ...
      _parse(e) {
        let { status: t, ctx: n } = this._processInputParams(e),
          r = (i, l) => {
            ...
            let o = Ki(i.value, l.value);
            return o.valid
              ? ((Qi(i) || Qi(l)) && t.dirty(), { status: t.value, value: o.data })
    ...
    da.create = (e, t, n) => new da({ left: e, right: t, typeName: H.ZodIntersection, ...$(n) });
    ...
    var mr = class extends G {
        ...
        static create(e, t, n) {
          return t instanceof G
            ? new mr({ keyType: e, valueType: t, typeName: H.ZodRecord, ...$(n) })
            : new mr({ keyType: mt.create(), valueType: e, typeName: H.ZodRecord, ...$(t) });
        }
      },
      pr = class extends G {
        get keySchema() {
    ...
    pr.create = (e, t, n) => new pr({ valueType: t, keyType: e, typeName: H.ZodMap, ...$(n) });
    var En = class extends G {
      ...
      min(e, t) {
        return new En({ ...this._def, minSize: { value: e, message: I.toString(t) } });
      }
      max(e, t) {
        return new En({ ...this._def, maxSize: { value: e, message: I.toString(t) } });
      }
      size(e, t) {
    ...
    En.create = (e, t) =>
      new En({ valueType: e, minSize: null, maxSize: null, typeName: H.ZodSet, ...$(t) });
    var Jn = class extends G {
        ...
        _parse(e) {
          ...
          if (t.parsedType !== N.function)
            return (
              L(t, { code: x.invalid_type, expected: N.function, received: t.parsedType }), z
            );
          function n(o, s) {
            return sr({
              data: o,
              path: t.path,
              errorMaps: [t.common.contextualErrorMap, t.schemaErrorMap, or(), ra].filter(
                (c) => !!c,
              ),
    ...
    ua.create = (e, t) => new ua({ getter: e, typeName: H.ZodLazy, ...$(t) });
    var ma = class extends G {
      _parse(e) {
        if (e.data !== this._def.value) {
          let t = this._getOrReturnCtx(e);
          return (
            L(t, { received: t.data, code: x.invalid_literal, expected: this._def.value }), z
          );
        }
    ...
    ma.create = (e, t) => new ma({ value: e, typeName: H.ZodLiteral, ...$(t) });
    function Qs(e, t) {
      ...
      _parse(e) {
        if (typeof e.data != "string") {
          let t = this._getOrReturnCtx(e),
            n = this._def.values;
          return (
            L(t, { expected: te.joinValues(n), received: t.parsedType, code: x.invalid_type }), z
          );
        }
    ...
    var pa = class extends G {
      _parse(e) {
        ...
        if (n.parsedType !== N.string && n.parsedType !== N.number) {
          ...
          return (
            L(n, { expected: te.joinValues(r), received: n.parsedType, code: x.invalid_type }), z
          );
        }
    ...
    pa.create = (e, t) => new pa({ values: e, typeName: H.ZodNativeEnum, ...$(t) });
    ...
    kn.create = (e, t) => new kn({ type: e, typeName: H.ZodPromise, ...$(t) });
    ...
    fr.create = (e) => new fr({ typeName: H.ZodNaN, ...$(e) });
    var Gm = Symbol("zod_brand"),
      ...
      Ir = class extends G {
        ...
        static create(e, t) {
          return new Ir({ in: e, out: t, typeName: H.ZodPipeline });
        }
      },
      gr = class extends G {
        _parse(e) {
    ...
    gr.create = (e, t) => new gr({ innerType: e, typeName: H.ZodReadonly, ...$(t) });
    var Js = (e, t = {}, n) =>
        e
...
`),
      z4 = ({ projectId: e, configFile: t, goToNext: n }) => {
        ...
        let [{ data: r, fetching: i, error: l }] = gl({ query: j4, variables: { projectId: e } });
        return a.createElement(
          fe,
          {
            footer: a.createElement(
              ...
              a.createElement(Je, { push: !0 }, a.createElement(Or, null)),
            ),
          },
          a.createElement(
            ue,
...
`),
    ...
    function J4({ createdProjectId: e, setCreatedProjectId: t, onSelectProjectId: n }) {
      let [{ data: r, fetching: i, error: l }, o] = gl({ query: G4 });
      X(() => {
                      ...
                      d?.projects?.map(
                        (h) =>
                          ...
                          a.createElement(Xe, {
                            ...
                            key: h.id,
                            title: h.name,
                            right: a.createElement(wd, { "aria-label": h.name }),
                            onClick: () => f(h),
                            disabled: u,
                          }),
                      ),
    ...
    var X4 = () =>
      ...
      i0 = De(r0),
      va = () => bt(i0, "RunBuild"),
      np = ({ children: e, watchState: t = r0 }) => a.createElement(i0.Provider, { value: t }, e),
      l0 = { PENDING: "warn", FAILED: "error", DENIED: "error", BROKEN: "error" },
    ...
    function F(e) {
      ...
      return F.array(e) ? "Array" : F.plainFunction(e) ? "Function" : Rr(e) || "Object";
    }
    ...
    function qo(e, t, n) {
      ...
      if (!T.nullOrUndefined(l)) {
        if (T.defined(c)) {
          if (T.array(c) || T.plainObject(c)) return Ep(c, d, l);
        } else return _e(d, l);
        return !1;
      }
    ...
    function Yo(e) {
      return ([t, n]) =>
        T.array(e)
          ? _e(e, n) || e.some((r) => _e(r, n) || (T.array(n) && Ml(n)(r)))
          : T.plainObject(e) && e[t]
            ? !!e[t] && _e(e[t], n)
            : _e(e, n);
    }
    ...
    function Qo(e) {
      return (t) => (T.array(e) ? e.some((n) => _e(n, t) || (T.array(t) && Ml(t)(n))) : _e(e, t));
    }
    function Pn(e, t) {
    ...
    var Va = at(ll(), 1),
      vi = at(ll(), 1),
      M = at(pd()),
      ya = typeof window < "u" && typeof document < "u" && typeof navigator < "u",
      xp = (function () {
    ...
    function Fl(e, t) {
      ...
      return ((r && !n ? t.contains(s) : t === s && s.nodeName !== "BODY") && (u = Tp(u, t)), u);
    }
    function Zp(e) {
    ...
    function Al(e, t, n, r) {
      ...
      if (r === "viewport") l = Zp(o, i);
        ...
        var s = void 0;
        r === "scrollParent"
          ? ((s = ba(Nl(t))), s.nodeName === "BODY" && (s = e.ownerDocument.documentElement))
          : r === "window"
    ...
    function g0(e, t, n, r, i) {
      ...
      var o = Al(n, r, l, i),
        ...
        c = Object.keys(s)
          .map(function (p) {
            return Qe({ key: p }, s[p], { area: Ip(s[p]) });
          })
          .sort(function (p, f) {
    ...
    function b0(e, t, n) {
      ...
      var r = y0(e),
        ...
        d = l ? "width" : "height";
      return (
        (i[o] = t[o] + t[c] / 2 - r[c] / 2), n === s ? (i[s] = t[s] - r[d]) : (i[s] = t[br(s)]), i
      );
    }
    function Ea(e, t) {
    ...
    function Bp() {
      if (!this.state.isDestroyed) {
        ...
        ((e.offsets.reference = v0(
          ...
          (e.offsets.popper = b0(this.popper, e.offsets.reference, e.placement)),
    ...
    function C0(e, t, n, r) {
      ...
      (l.addEventListener(t, n, { passive: !0 }), i || C0(ba(l.parentNode), t, n, r), r.push(l));
    }
    function Vp(e, t, n, r) {
      ((n.updateBound = r), w0(e).addEventListener("resize", n.updateBound, { passive: !0 }));
      var i = ba(e);
      return (
    ...
    function Up(e) {
      return (
        ...
        e.arrowElement && Object.keys(e.arrowStyles).length && el(e.arrowElement, e.arrowStyles),
        e
      );
    }
    function $p(e, t, n, r, i) {
      var l = v0(i, t, e, n.positionFixed),
        o = g0(n.placement, l, t, e, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
      return (
    ...
    function Gp(e, t) {
      var n = t.x,
        r = t.y,
        i = e.offsets.popper,
        l = Ea(e.instance.modifiers, function (v) {
    ...
    function Yp(e, t) {
      ...
      return (
        ...
        (e.arrowElement = r),
        (e.offsets.arrow = ((n = {}), Sn(n, u, Math.round(v)), Sn(n, p, ""), n)),
        e
      );
    }
    function Qp(e) {
    ...
    function Kp(e, t) {
      if (k0(e.instance.modifiers, "inner") || (e.flipped && e.placement === e.originalPlacement))
        return e;
      var n = Al(
          e.instance.popper,
    ...
    function n3(e, t) {
      ...
      var r = Ll("transform"),
        ...
        s = i[r];
      ((i.top = ""), (i.left = ""), (i[r] = ""));
      var c = Al(e.instance.popper, e.instance.reference, t.padding, n, e.positionFixed);
      ...
      var d = t.priority,
        ...
        u = {
          primary: function (p) {
            var f = m[p];
            return (
              m[p] < c[p] && !t.escapeWithReference && (f = Math.max(m[p], c[p])), Sn({}, p, f)
            );
          },
    ...
    function r3(e) {
      ...
      var t = e.offsets.reference,
        n = Ea(e.instance.modifiers, function (r) {
        ...
        function e(t, n) {
          ...
          (Op(this, e),
            ...
            this.modifiers.forEach(function (o) {
              o.enabled && u0(o.onLoad) && o.onLoad(r.reference, r.popper, r.options, o, r.state);
            }),
            this.update());
    ...
    function l1(e, t, n) {
      ...
      if (!_.nullOrUndefined(l)) {
        if (_.defined(c)) {
          if (_.array(c) || _.plainObject(c)) return k3(c, d, l);
        } else return He(d, l);
        return !1;
      }
    ...
    function s1(e) {
      return function (t) {
        ...
        return _.array(e)
          ? He(e, r) ||
              e.some(function (i) {
                return He(i, r) || (_.array(r) && Ol(r)(i));
              })
          : _.plainObject(e) && e[n]
            ? !!e[n] && He(e[n], r)
            : He(e, r);
    ...
    function c1(e) {
      return function (t) {
        return _.array(e)
          ? e.some(function (n) {
              return He(n, t) || (_.array(t) && Ol(t)(n));
            })
          : He(e, t);
      };
    }
    ...
    function C3(e, t) {
      ...
      var n = function (u, p) {
        ...
        o = function (u, p, f) {
          if (!_.defined(u)) return !1;
          try {
            return i1(e, t, { key: u, actual: p, previous: f, type: "decreased" });
          } catch {
            return !1;
          }
        },
        ...
        d = function (u, p, f) {
          if (!_.defined(u)) return !1;
          try {
            return i1(e, t, { key: u, actual: p, previous: f, type: "increased" });
          } catch {
            return !1;
          }
        },
        ...
        wa(n, [
          {
            ...
            value: function () {
              ct() && (this.node || this.appendNode(), Hn || this.renderPortal());
            },
          },
          {
            key: "componentDidUpdate",
            value: function () {
              ct() && (Hn || this.renderPortal());
            },
          },
          {
            ...
            value: function () {
              !ct() ||
                !this.node ||
                (Hn || On.unmountComponentAtNode(this.node),
                this.node &&
          ...
          },
          {
            ...
            value: function () {
              ...
              var r = this.props,
                i = r.children,
                l = r.setRef;
              if ((this.node || this.appendNode(), Hn)) return On.createPortal(i, this.node);
              var o = On.unstable_renderSubtreeIntoContainer(
                this,
    ...
    O0.propTypes = { handleClick: M.default.func.isRequired, styles: M.default.object.isRequired };
    function _0(e) {
      var t = e.content,
        n = e.footer,
        r = e.handleClick,
      ...
      return (
        ...
        (o || l) &&
          !_.boolean(i) &&
          (d.close = a.createElement(O0, { styles: c.close, handleClick: r })),
        a.createElement(
          "div",
            ...
            value: function () {
              ...
              return (
                i
                  ...
                  : (d.content = a.createElement(_0, this.props)),
                c === ee.OPEN && m.push("__floater__open"),
                o || (d.arrow = a.createElement(T0, this.props)),
                a.createElement(
                  "div",
    ...
    Ae(_l, "propTypes", {
      ...
      children: M.default.node,
      component: m1(M.default.oneOfType([M.default.func, M.default.element]), function (e) {
        return !e.content;
      }),
      content: m1(M.default.node, function (e) {
        return !e.component;
      }),
    ...
    var z3 = at(hd(), 1),
      ...
      $3 = (e, t, n) =>
        t in e
          ...
          : (e[t] = n),
      O = (e, t, n) => ($3(e, typeof t != "symbol" ? t + "" : t, n), n),
      oe = {
        INIT: "init",
        START: "start",
        STOP: "stop",
    ...
    function K3(e, t, n) {
      var r;
      if (!e) return 0;
      let { offsetTop: i = 0, scrollTop: l = 0 } = (r = (0, d0.default)(e)) != null ? r : {},
    ...
    function lh(e, t) {
      ...
      let l = {
        ...
        o = {
          ...
          buttonNext: { ...jn, backgroundColor: r.primaryColor, borderRadius: 4, color: "#fff" },
          buttonBack: { ...jn, color: r.primaryColor, marginLeft: "auto", marginRight: 5 },
          buttonClose: {
            ...jn,
            color: r.textColor,
            height: 14,
    ...
    function zn(e, t) {
      var n, r, i, l, o, s;
      let c = e ?? {},
        d = Va.default.all([ah, oh(t), c], { isMergeableObject: T.plainObject }),
        m = lh(t.styles, d.styles),
        u = Hr(Rt(d.target), d.disableScrollParentFix),
        p = Va.default.all([
          nh,
      ...
      return (
        ...
        {
          ...d,
          locale: Va.default.all([P0, (s = t.locale) != null ? s : {}, d.locale || {}]),
          floaterProps: p,
      ...
      ch = class {
        constructor(e) {
          (O(this, "beaconPopper"),
            ...
            O(this, "update", (i) => {
              var l;
              if (!X3(i, y1)) throw new Error(`State is not valid. Valid keys: ${y1.join(", ")}`);
              this.setState({
                ...this.getNextState(
      ...
      `),
        ...
        render() {
          let {
            ...
            d = T.string(i.open) ? i.open : (0, z3.default)(i.open),
    ...
    var hh = ph,
      fh = class extends Nt {
        ...
        render() {
          ...
          let c = s.overlay;
          f1() && (c = o === "center" ? s.overlayLegacyCenter : s.overlayLegacy);
          let d = {
      ...
      gh = class extends Nt {
        ...
        componentDidMount() {
          ...
          Ot() &&
            ...
            (this.node.id = e),
            document.body.appendChild(this.node),
            Dn || this.renderReact15());
        }
        componentDidUpdate() {
          Ot() && (Dn || this.renderReact15());
        }
        componentWillUnmount() {
          !Ot() ||
            !this.node ||
        ...
        renderReact16() {
          if (!Ot() || !Dn) return null;
          let { children: e } = this.props;
          return this.node ? _n(e, this.node) : null;
        }
        render() {
    ...
    function bh(e) {
      ...
      return (
        ...
        (Q.close = !f && S(yh, { "data-test-id": "button-close", styles: h.buttonClose, ...n })),
        S(
          "div",
          {
            key: "JoyrideTooltip",
    ...
    var Eh = bh,
          ...
          return !V0(s) || !T.domElement(c)
            ...
            : S(
                ...
                S(
                  ...
                  S(fh, { ...s, debug: t, lifecycle: r, onClickOverlay: this.handleClickOverlay }),
                ),
                S(
                  _l,
                  {
      ...
      H0 = class extends Nt {
        constructor(e) {
          ...
          ((this.store = dh({ ...e, controlled: r && T.number(i) })),
        ...
        componentDidUpdate(e, t) {
          ...
          if (v("action", [oe.NEXT, oe.PREV, oe.SKIP, oe.CLOSE]) && v("status", K.PAUSED)) {
            let de = zn(m[t.index], this.props);
            this.callback({
              ...Q,
              index: t.index,
    ...
    var Ch = H0,
      ...
      kr = ([e, ...t]) => t.reduce((n, r) => (b1.indexOf(r) > b1.indexOf(n) ? r : n), e);
    function Sh(e) {
      return (e.FAILED ?? 0) > 0
        ? "FAILED"
        : (e.IN_PROGRESS ?? 0) > 0
      ...
      let {
          ...
          (u, p) => (
            ...
            p.comparisons?.forEach(({ browser: f, result: g }) => {
              u.resultsByBrowser[f.id] = kr([g ?? void 0, u.resultsByBrowser[f.id]]);
            }),
            p.comparisons?.forEach(({ result: f }) => {
              u.resultsByMode[p.mode.name] = kr([f ?? void 0, u.resultsByMode[p.mode.name]]);
            }),
    ...
    var xh = (e) => {
      ...
      D0 = ({ result: e }) => e !== "EQUAL" && e !== "FIXED",
      Mh = (e, t) => {
        let n = e.filter((i) => i.comparisons.some(D0)),
          r = n.length ? n : e;
...
`),
      Ih = ({ projectId: e, storyId: t, gitInfo: n, selectedBuildInfo: r }) => {
        let [{ data: i, error: l, operation: o }, s] = gl({
          query: Ah,
          variables: {
            projectId: e,
            storyId: t,
        ...
        let c = o && t && o.variables.storyId !== t,
          ...
          m = [
            ...hn(Oh, d && "testsForStory" in d && d.testsForStory ? d.testsForStory.nodes : []),
          ],
          u = d?.committedAt > n.committedAt,
          p = !!d && !u,
          f = !!d && m.every((y) => y.status !== "IN_PROGRESS"),
          g = hn(Th, i?.selectedBuild ?? (f ? i?.project?.lastBuildOnBranch : void 0));
        return {
      ...
      Rh = () => bt(Il, "Build"),
      U0 = () => {
        let { selectedBuild: e } = bt(Il, "Build");
      ...
      return (
        ...
        _n(
          a.createElement(
            ...
            a.createElement(ro, { colors: i, drawShape: Hh, ...l }),
          ),
          o,
        )
      );
    ...
    var Dh = w.div(({ theme: e }) => ({
      ...
      jh = w.div({ display: "flex", flexDirection: "column", alignItems: "flex-start" }),
      zh = w.div(({ theme: e }) => ({
        fontSize: 13,
        lineHeight: "18px",
        fontWeight: 700,
      ...
      Qh = w(j)({ display: "flex", flexDirection: "column", gap: 10, width: 200, marginTop: 15 });
      ...
      return a.createElement(
        ...
        a.createElement(
          ...
          typeof e.buildProgressPercentage == "number" &&
            a.createElement(_s, { style: { width: `${e.buildProgressPercentage}%` } }),
        ),
        a.createElement(vl, { center: !0, muted: !0, small: !0, localBuildProgress: e }),
      );
    }
    var Kh =
            ...
            : d && (!t || (t && s))
              ...
              : t?.currentStep === "complete" && !u && !k
                ...
                : u && !i
                  ...
                  : i
                    ? a.createElement(w1, { onComplete: l, onSkip: o, ranSecondBuild: u && k })
                    : null;
      },
      h7 = w.div(({ theme: e }) => ({
      ...
      f7 = At({ from: { transform: "rotate(0deg)" }, to: { transform: "rotate(359deg)" } }),
      g7 = w(Y1)({ animation: `${f7} 1s linear infinite` }),
      Da = { width: 10, marginRight: 8 },
      ...
      E7 = ({ localBuildProgress: e, expanded: t = !1 }) => {
        ...
        let r = ["aborted", "error"].includes(e.currentStep),
          i = Hi.map((l) => {
            ...
            return d
              ? { ...u, icon: a.createElement(It, { style: Da }), renderLabel: u.renderProgress }
              : c
                ? { ...u, icon: a.createElement(g7, { style: Da }), renderLabel: u.renderProgress }
                : m
                  ? { ...u, icon: a.createElement(Ad, { style: Da }), renderLabel: u.renderName }
                  : {
                      ...u,
                      icon: a.createElement(ol, { style: Da }),
      ...
      k7 = ({
        ...
        if (n) {
          ...
          return a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(x1, { percentage: n.buildProgressPercentage, isWarning: u }),
              a.createElement(
                ja,
                null,
              ...
              m
                ...
                : a.createElement(
                    Ke,
                    { as: "div" },
                    l ? a.createElement(Td, null) : a.createElement(Ld, null),
                  ),
            ),
        ...
        return a.createElement(S1, { onClick: i }, a.createElement(x1, { percentage: 100 }), c());
      },
      w7 = ({ onClose: e }) =>
        a.createElement(
          zs,
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(Sl, { onClick: e }, a.createElement(Cl, { "aria-label": "Close" })),
            ),
          ...
          a.createElement(
            qi,
            null,
            a.createElement(lr, null, "Bounding box", a.createElement(No, null)),
            a.createElement(
              "dl",
              null,
      ...
      q0 = De(W0),
      G0 = () => bt(q0, "ReviewTest"),
      C7 = ({ children: e, watchState: t = W0 }) => a.createElement(q0.Provider, { value: t }, e),
      S7 = w.div(
        ({ theme: e }) => ({
          position: "relative",
          display: "flex",
      ...
      N7 = ({
        ...
        let p = Dt(),
          ...
          [Q, de] = a.useState(!1),
          ge = o ? C : v,
          ke = M7({ comparisonImageLoaded: R, focusImageLoaded: Q, showDiff: b, showFocus: h });
        return a.createElement(
          S7,
          { ...u, ...k },
          i &&
          ...
          g &&
            ...
            a.createElement(
              x7,
              null,
              a.createElement(fd, { color: p.base === "light" ? "currentColor" : p.color.medium }),
              a.createElement(
                j,
                { center: !0, muted: !0 },
      ...
      _7 = ({ isAccepted: e, selectedBrowser: t, browserResults: n, onSelectBrowser: r }) => {
        Dt();
        let i = kr(n.map(({ result: s }) => s));
        if (!i) return null;
        let l = N1[t.key];
        !e && i !== "EQUAL" && n.length >= 2 && (l = a.createElement(ir, { status: i }, l));
        let o =
          n.length > 1 &&
          n.map(({ browser: s, result: c }) => ({
            ...
            id: s.id,
            onClick: () => r(s),
            right: !e && c !== "EQUAL" && a.createElement(Os, { status: c }),
            icon: N1[s.key],
            title: s.name,
          }));
        return a.createElement(
          ...
          o
            ...
            : a.createElement(O7, null, l, a.createElement(F1, null, t.name)),
        );
      },
      Z7 = w.div(({ theme: e }) => ({
        alignItems: "center",
      ...
      R7 = ({ isAccepted: e, modeOrder: t, modeResults: n, onSelectMode: r, selectedMode: i }) => {
        Dt();
        let l = kr(n.map(({ result: c }) => c));
        if (!l) return null;
        let o = a.createElement(Nd, null);
        !e && l !== "EQUAL" && n.length >= 2 && (o = a.createElement(ir, { status: l }, o));
        let s =
          n.length > 1 &&
          n
            .map(({ mode: c, result: d }) => ({
              id: c.name,
              title: c.name,
              right: !e && d !== "EQUAL" && a.createElement(Os, { status: d }),
              onClick: () => r(c),
          ...
          : t === "positive"
            ...
            : t === "warning"
              ...
              : {
                  ...
                  borderWidth: 0,
                  borderColor:
                    e.base === "light" ? Wa(0.2, e.color.secondary) : zt(0.1, e.color.secondary),
                  "&:hover": {
                    color: e.color.lightest,
      ...
      T1 = w.div({ display: "flex", flexDirection: "row" }),
      wr = w.div(
        ({ theme: e }) => ({
          width: 12,
          height: 12,
                    ...
                    a.createElement(
                      ...
                      (Z) =>
                        a.createElement(
                          ...
                          g
                            ? a.createElement(wr, { parentComponent: "IconButton" })
      ...
      Ci = { width: 12, height: 12, margin: "3px 3px 3px 6px", verticalAlign: "top" },
      z7 = ({ icon: e }) => {
        let { color: t } = Dt();
        return {
    ...
    function _6(e, t, n) {
      ...
      var d = Q0(O6(n), { addSuffix: !!n?.addSuffix, comparison: c }),
        m,
        u;
    ...
    function Z6(e, t) {
      return (jr(1, arguments), _6(e, Date.now(), t));
    }
    var I6 = {
    ...
    var B6 = (e) => Z6(e, { addSuffix: !0, locale: { ...Y0, formatDistance: R6 } }),
      Wn = w.div(({ theme: e }) => ({
        gridArea: "info",
        display: "flex",
        justifySelf: "start",
  ...
  `,
      ...
      z6 = ({
        ...
        let { baselineImageVisible: s, diffVisible: c, focusVisible: d } = Tr(),
          { toggleBaselineImage: m, toggleSettings: u, toggleWarnings: p } = Mn(),
          f = U0(),
        ...
        return a.createElement(
          ...
          a.createElement(
            V1,
            null,
            a.createElement(B1, null, Q, a.createElement(D7, { isOutdated: e })),
          ),
          a.createElement(
            H6,
            null,
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              "p",
              null,
              a.createElement(le, { variant: "outline" }, a.createElement(U1, null), "Docs"),
              a.createElement(le, { variant: "outline" }, a.createElement(xd, null), "Get support"),
            ),
          ),
        );
    w.div(({ theme: e }) => ({
    ...
    var W6 = ({
        ...
        let { settingsVisible: o, warningsVisible: s } = Tr(),
      ...
      q6 = ({
        ...
        let { setAccessToken: o } = Is(),
          { isRunning: s, startBuild: c } = va(),
          { disable: d, disableSnapshot: m, docsOnly: u } = Dl("chromatic", {}),
          p = () => {
            ...
            return i
              ? i.currentStep === "error"
                ? a.createElement(
                    a.Fragment,
                    null,
                    a.createElement($0, { localBuildProgress: i, title: "Build failed" }),
                    f,
                  )
...
`),
      ...
      J6 = ({
        ...
        let m = an(),
          ...
          g = Ih({ projectId: s, storyId: d, gitInfo: c, selectedBuildInfo: t }),
          {
            account: y,
            features: k,
            manageUrl: b,
        ...
        X(() => l(!Q), [Q, l]);
        let me =
            C && "testsForStatus" in C && C.testsForStatus?.nodes && hn(j0, C.testsForStatus.nodes),
          st = R && rp(m, me || []);
        (X(() => {
          o((Mt) => ({ ...G6(Mt), ...st }));
        }, [JSON.stringify(st), o]),
        ...
        return async (t, { signal: n, ...r } = {}) => {
          ...
          return (
            n?.addEventListener("abort", () => {
              (e(Gd, { requestId: i }), sn.get(i)?.reject(n.reason), sn.delete(i));
            }),
      ...
      tf = ({ active: e, api: t }) => {
        let [n, r] = hs(),
          i = D(
            (Oe) => {
              (r(Oe), Oe || Q2("authenticationScreen", "exchangeParameters"));
            },
            [r],
          ),
          { storyId: l } = rn(),
        ...
        X(() => {
          ...
          return (
            ...
            () => {
              (window.removeEventListener("online", Oe), window.removeEventListener("offline", xa));
            }
          );
        }, []);
        let [c] = we(Dd),
        ...
        if (!e) return Te(null);
        if (window.CONFIG_TYPE !== "DEVELOPMENT") return Te(a.createElement(X4, null));
        if (de) return Te(a.createElement(tp, null));
        if (m) return Te(a.createElement(ep, { offline: m }));
        if (!n)
          return Te(
            a.createElement(B4, { setAccessToken: i, setCreatedProjectId: Q, hasProjectId: !!h }),
          );
        ...
        if (d || !c) return (console.error(d), Te(a.createElement(V4, null)));
        if (C) {
          if (!v) throw new Error("Missing config file after configuration failure");
          return Te(a.createElement(q4, { projectId: h, configFile: v }));
        }
        if (Z) {
          if (!v) throw new Error("Missing config file after configuration success");
          return Te(a.createElement(z4, { projectId: h, configFile: v, goToNext: R }));
        }
