function Y(c, h) {
  for (var y = 0; y < h.length; y++) {
    ...
    if (typeof p != "string" && !Array.isArray(p)) {
      for (const _ in p)
        if (_ !== "default" && !(_ in c)) {
          const m = Object.getOwnPropertyDescriptor(p, _);
          m && Object.defineProperty(c, _, m.get ? m : { enumerable: !0, get: () => p[_] });
        }
    }
  }
...
function ee() {
  ...
  var C = {
    ...
    x = {};
  function v(e, t, n) {
    ((this.props = e), (this.context = t), (this.refs = x), (this.updater = n || C));
  }
  ...
  var E = (g.prototype = new I());
  ((E.constructor = g), P(E, v.prototype), (E.isPureReactComponent = !0));
  var q = Array.isArray,
  ...
  function M(e, t, n) {
    ...
    return { $$typeof: c, type: e, key: f, ref: l, props: o, _owner: O.current };
  }
  function J(e, t) {
  ...
  function S(e, t, n, u, o) {
          ...
          : o != null &&
            (j(o) &&
              (o = J(
                o,
                n +
                  (!o.key || (l && l.key === o.key) ? "" : ("" + o.key).replace(T, "$&/") + "/") +
                  e,
              )),
            t.push(o)),
        1
    ...
    if (((l = 0), (u = u === "" ? "." : u + ":"), q(e)))
      ...
      for (e = i.call(e), s = 0; !(f = e.next()).done;)
        ((f = f.value), (i = u + w(f, s++)), (l += S(f, t, n, i, o)));
    else if (f === "object")
      throw (
        (t = String(e)),
        Error(
  ...
  var a = { current: null },
    R = { transition: null },
    X = { ReactCurrentDispatcher: a, ReactCurrentBatchConfig: R, ReactCurrentOwner: O };
  function V() {
  ...
  return (
    ...
    (r.cloneElement = function (e, t, n) {
      ...
      if (t != null) {
        if (
          (t.ref !== void 0 && ((f = t.ref), (l = O.current)),
...
var N;
function te() {
  return (N || ((N = 1), (k.exports = ee())), k.exports);
}
var U = te();
const re = Z(U),
  oe = Y({ __proto__: null, default: re }, [U]);
export { re as R, oe as a, te as b, ne as c, Z as g, U as r };
